...
Another approach could have been to directly model changes in the drift rate. This could be done within an experiment where the range of values are manipulated block by block (e.g., as done in \citeNP{Mullett2013}). 
